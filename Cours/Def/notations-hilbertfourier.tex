...
\def\ltfs{\stackrel{\mathrm{DFS}}{\leftrightarrow}}
\def\ltfd{\stackrel{\mathrm{DFT}}{\leftrightarrow}}
\def\ltz{\stackrel{Z}{\leftrightarrow}}
...
\newcommand{\translation}{\operatorname{B}}
...
\newcommand{\filter}[1]{\operatorname{F}_{#1}}
\newcommand{\ec}[1]{\rme^{-\rmi \omega #1}}
\newcommand{\ROC}[1]{\mathrm{ROC}(#1)}